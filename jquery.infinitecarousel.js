	...
	$.fn.extend({ 
		...
		var options = $.extend(defaults, options);
    		...
    		return this.each(function() {
				...
				// largeur de la div showtext #rac
				$('#textholder'+randID).width(imgWidth-(correctTHWidth * 2)).height((imgHeight*o.textholderHeight-110)-(correctTHHeight * 2)).css({'backgroundColor':'#FFF','opacity':'0.5'});
				...
				$('#play_btn'+randID).click(function(){
					...
					clearInt=setInterval(function(){anim('next');},80000+o.displayTime+o.transitionSpeed);
				...
				if(o.displayThumbnails)
				{
					...
					// les délices #Rac021
					$('#thumbs'+randID).append('<li><a href="index.php?page=delices#wrap"> Nos d&eacute;lices </a></li>');
							...
							$('ul', obj)
								.animate({left:-imgWidth*2},o.transitionSpeed,function(){
									...
									if(autopilot)
									{
										...
										$('#progress'+randID).animate({'width':0},80000+o.displayTime,function(){
				...
				var clearInt = setInterval(function(){anim('next');},80000+o.displayTime+o.transitionSpeed);
				$('#progress'+randID).animate({'width':0},80000+o.displayTime+o.transitionSpeed,function(){
